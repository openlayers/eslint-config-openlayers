 ...
 */
import doctrine from '@openlayers/doctrine';
...
export default {
  ...
  create(context) {
     ...
     * @param {Object} type JSDoc tag
     * @return {{currentType: Doctrine.Type, expectedTypeName: string}} The current type annotation and
     ...
     * @param {{range: Array<number>}} parsedJsdocNode A tag or other node which was parsed from this comment
     * @return {{start: SourceLocation, end: SourceLocation}} The 0-based source location for the tag
     */
